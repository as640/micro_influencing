...
export const communityApi = {
    trends: () => request('GET', '/community/trends/'),
    topicDetail: (id) => request('GET', `/community/trends/${id}/`),
    myCategories: () => request('GET', '/community/categories/'),

    listCampaigns: (statusFilter = '') =>
        request('GET', `/community/campaigns/${statusFilter ? '?status=' + statusFilter : ''}`),
    campaignDetail: (id) => request('GET', `/community/campaigns/${id}/`),
    suggestCampaign: (data) => request('POST', '/community/campaigns/', data),

    endorse: (id, note = '') =>
        request('POST', `/community/campaigns/${id}/endorse/`, { note }),
    unendorse: (id) => request('DELETE', `/community/campaigns/${id}/endorse/`),

    refresh: () => request('POST', '/community/admin/refresh/', {}),
};
